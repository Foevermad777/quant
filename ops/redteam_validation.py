...
from executor.config import ACCEPTANCE_DIR, ExecutorConfig
from executor.redteam_validation import render_markdown, run_validation, write_report
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run R1-R3 red-team validation gates.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    config = ExecutorConfig(
        ...
        disciplined_db_path=base_config.disciplined_db_path,
        ...
        block_limit_up_open=base_config.block_limit_up_open,
        block_limit_down_open=base_config.block_limit_down_open,
    ...
    if args.output:
        ...
        default_output = ACCEPTANCE_DIR / f"R1_R3_REDTEAM_VALIDATION_{date.today():%Y%m%d}.md"
